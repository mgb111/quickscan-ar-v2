          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="mb-2 text-xs text-blue-700 bg-blue-50 rounded p-2">
                Generate your marker file using the <a href="https://hiukim.github.io/mind-ar-js/tools/marker/" target="_blank" rel="noopener noreferrer" className="underline text-blue-800">MindAR Marker Trainer</a> and upload the resulting <b>.mind</b> file here.
              </div>
              <div
                ...
                onDrop={(e) => {
                  ...
                  if (file.name.endsWith('.mind')) {
                    ...
                    alert('Please upload a .mind file generated by the MindAR Marker Trainer.');
                  }
                }}
              >
                <input
                ...
                {markerFile ? (
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">Drop .mind marker file here</p>
